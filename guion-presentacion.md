...
*Detalle que puedes añadir si quieres:* el nombre va escrito en minúscula y, en la portada, la línea que dice «abogados del trabajo y de la seguridad social» está escrita **literalmente en letra pequeña**. El nombre no es solo un nombre, es la broma visual de la página.
...
Portada con el nombre grande y el claim: *«La letra pequeña de tu contrato es la que decide tu vida. Aquí la leemos contigo, en voz alta y en tu idioma.»* Debajo, los cuatro datos que un cliente busca de verdad: dónde estamos, en qué idiomas atendemos, que la primera consulta es gratis y desde cuándo existimos.
...
> En resumen: un despacho pequeño, de ocho personas, especializado solo en derecho del trabajo y de la seguridad social, con atención en español y en italiano. La web está construida sobre una sola idea —**que la letra pequeña se explique**— y todo, desde el nombre hasta las notas al margen, sale de ahí.
